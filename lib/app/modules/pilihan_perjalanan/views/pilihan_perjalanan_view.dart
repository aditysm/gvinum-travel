...
class PilihanPerjalananView extends GetView<PilihanPerjalananController> {
  ...
  Widget build(BuildContext context) {
    ...
    controller.fetchBookingPackage();
    controller.dibatalkanList.refresh();
    controller.dikonfirmasiList.refresh();
    controller.diprosesList.refresh();
    return Scaffold(
                          ...
                          : Container(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  ...List.generate(
                                      controller.diprosesList.length,
                                      (diprosesIndex) {
                                    return ListTile(
                                      onTap: () {
                                        if (isPerjalananSaya) {
